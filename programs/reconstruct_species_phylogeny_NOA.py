...
def RAxML_tree_search(tmp_folder, msa_path, final_tree_name, logger, num_of_cpus, outgroup, num_of_bootstrap_iterations, phylogenetic_tree_path, seed):
...
def generate_phylogenetic_tree(logger,msa_path, phylogenetic_tree_path, seed, program, outgroup, num_of_bootstrap_iterations,
                               num_of_cpus):
    ...
    if program=='raxml':
        RAxML_tree_search(tmp_folder,msa_path,final_tree_name, logger,num_of_cpus,outgroup,num_of_bootstrap_iterations,phylogenetic_tree_path, seed)
    elif program=='iqtree':
        iqtree_tree_search(tmp_folder,msa_path,final_tree_name, logger,num_of_cpus,outgroup,num_of_bootstrap_iterations,phylogenetic_tree_path, seed)
    elif program=='fasttree':
        fasttree_tree_search(tmp_folder,msa_path,final_tree_name, logger,num_of_cpus,outgroup,num_of_bootstrap_iterations,phylogenetic_tree_path, seed)
